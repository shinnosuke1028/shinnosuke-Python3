...
mail_file_path = '../../Python_service_daily/data/'    # D:\FTP\Mail\
...
file_title_gather = 'S_DATE', 'DATA_STYLE', 'HOUR', '包内数据时间', \
                'NORMAL_FILE_NUM', 'NOW_NUM', 'BEF_NUM', \
                'NORMAL_FILE_SIZE/MB', 'NOW_SIZE/MB', 'BEF_SIZE/MB', \
                'FILE_NUM<今-昨>', 'FILE_SIZE<今-昨>/MB', \
                'FILE_NUM_STATUS', 'FILE_SIZE_STATUS', 'PATH_NAME'

file_title_scheduler = '任务名', 'SUCCEED', 'FAILURE', '耗时', '下次执行时间', \
                       '执行间隔', '任务激活状态', '上次执行时间', '包内容'
